...
const CaseLLVN = () => {
    ...
    const messages = [
        ...
        "At the time, our village had a 8-foot levee in place. By sheer luck, the storm shifted course and struck another village located 5 miles away. As a result, the river near us rose only to 7 feet, and our village remained undamaged, experiencing 0% flood loss.",
                    ...
                    ref={(el) => {
                        ...
                        {index < currentLineIndex ? (
                            ...
                            <>
                                ...
                                {index === 2 && (
                                    <>
                                        <span style={normalText}>At the time, our village had a </span><span style={highlightNumber}>8-foot</span><span style={normalText}> levee in place. By sheer luck, the storm shifted course and struck another village located 5 miles away. As a result, the river near us rose only to </span><span style={highlightNumber}>7 feet</span><span style={normalText}>, and </span><span style={highlightResultWithUnderline}>our village</span><span style={highlightResult}> remained undamaged</span><span style={normalText}>, experiencing </span><span style={highlightResult}>0% flood loss</span><span style={normalText}>.</span>
                                    </>
                                )}
                                {index === 3 && (
                                    <>
                            ...
                            >
                                ...
                                {index === 2 && (
                                    <TypingText 
                                        ...
                                        highlightTexts={[
                                            ...
                                            { text: "our village remained undamaged", style: highlightResult },
                                ...
                                {index === 3 && (
                                    <TypingText 
                                        ...
                                        onComplete={handleLineComplete}
                                        highlightTexts={[
                                            { text: "other village suffered devastating floods and severe economic losses", style: highlightResult }
                                        ]}
                                    />
                                )}
                            </div>

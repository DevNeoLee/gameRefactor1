...
const CaseLLRN = () => {
    ...
    const messages = [
        ...
        "At the time, our village had a 8-foot levee in place. However, the storm weakened by chance, and the river near us rose only to 7 feet. As a result, our village remained undamaged and experienced 0% flood loss."
    ];
                    ...
                    ref={(el) => {
                        ...
                        {index < currentLineIndex ? (
                            ...
                            <>
                                ...
                                {index === 2 && (
                                    <>
                                        <span style={normalText}>At the time, our village had a </span><span style={highlightNumber}>8-foot</span><span style={normalText}> levee in place. However, the storm weakened by chance, and the river near us rose only to </span><span style={highlightNumber}>7 feet</span><span style={normalText}>. As a result, </span><span style={highlightResultWithUnderline}>our village</span><span style={highlightResult}> remained undamaged</span><span style={normalText}> and experienced </span><span style={highlightResult}>0% flood loss</span><span style={normalText}>.</span>
                                    </>
                                )}
                            </>
                        ) : index === currentLineIndex ? (
                            ...
                            >
                                ...
                                {index === 2 && (
                                    <TypingText 
                                        text="At the time, our village had a 8-foot levee in place. However, the storm weakened by chance, and the river near us rose only to 7 feet. As a result, our village remained undamaged and experienced 0% flood loss." 
                                        onComplete={handleLineComplete}
                                        highlightTexts={[

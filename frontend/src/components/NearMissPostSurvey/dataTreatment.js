...
const data = {
    ...
    "questions": [
        ...
        {
            "id": "14",
            "question": "Let us revisit the information provided to you prior to the start of this exercise. You were given information describing a past event related to the exercise (i.e., On one occasion, experts warned of a…). How often did you recall this information while making decisions during the exercise?",
            "type": "radio",
            "choices": [
                "Not at all",
                "Occassionally",
        ...
        {
            "id": "15",
            "question": "Once again, let us revisit the information provided to you prior to the start of this exercise. You were given information describing a past event related to the exercise (i.e., On one occasion, experts warned of a…). How useful was it for you to recall this information while making decisions across the rounds?",
            "type": "radio",
            "choices": [
                "Not useful at all",
                "Slightly useful",
